...
//						new BufferedInputStream(new FileInputStream(inputFileName(input, files.get(i)))), "UTF-8"));
//			}
//			outBuilder.deleteCharAt(outBuilder.length() - 1);
//			bw = new BufferedWriter(
//					new OutputStreamWriter(new FileOutputStream(outputFileName(input, outBuilder.toString())), "UTF-8"));
